    ...
    <div class="user-login-5" >
        <div class="row bs-reset">
            <div class="col-md-6 bs-reset mt-login-5-bsfix">
                <div class="login-bg" :style="{ backgroundImage: 'url(' + assetsDiff('img/login/bg1.jpg') + ')' }"></div>
            </div>
...
<script>
    export default {
        data () {
            return {
                backstretchImages: [
                    this.assetsDiff('img/login/bg1.jpg'),
                    this.assetsDiff('img/login/bg2.jpg'),
                    this.assetsDiff('img/login/bg3.jpg')
                ],
