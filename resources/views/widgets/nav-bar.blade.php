<!-- BEGIN HEADER MENU -->
<div class="page-header-menu" v-if="hasPrivilege('showHeaderMenu')">
...
<div class="page-header-menu" v-if="!hasPrivilege('showHeaderMenu')" style="height: 1px;background: rgba(68, 77, 88, 0.26);"></div>
<!-- END HEADER MENU -->